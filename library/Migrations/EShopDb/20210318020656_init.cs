        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2021, 3, 18, 9, 6, 55, 709, DateTimeKind.Local).AddTicks(7164)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 3, 18, 9, 6, 55, 723, DateTimeKind.Local).AddTicks(5775), 100000m, 200000m, null });
